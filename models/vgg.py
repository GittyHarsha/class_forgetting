...
from .model_utils import reshape_conv_input_activation, forward_cache_activations, forward_cache_activations_per_image, forward_cache_projections, forward_cache_svd
__all__ = [
        ...
        for layers in [self.features, self.classifier]:
            for layer in layers:
                if isinstance(layer, nn.Conv2d): 
                    ...
                    layer_ind+=1 
                x, layer_acts  = forward_cache_activations_per_image(x, layer, layer_key, max_samples)  
